...
//	console.log('Command last: ' + command.last);
	...
	if (command.arg !== player.name) {
		if (player.position === 'standing') {
			...
			if (opponent && opponent.roomid === player.roomid) {
				World.msgPlayer(player, {
					msg: '<strong class="grey">You ready for battle with a ' 
				...
				if (item) {
					...
					if (monster) {
						if (monster.description) {
							...
							itemDescription = monster.long + '. It is ' + monster.position + '.';
						}
...
Cmd.prototype.score = function(target, command) {
    ...
    var affectsText = '';
    if (target.affects.length == 0) {
        affectsText = '<li class="stat-affect">Unaffected</li>';
    }
    for (var i = 0; i < target.affects.length; i++) {
        affectsText += '<li class="stat-affect">' + target.affects[i].affect + '</li>';;
    }
		...
		'<div class="stats">' +
			'<div class="col-md-12">' +
				...
				'<ul class="col-md-12 score-info list-inline">' +
					...
					'<li class="stat-mana"><label>Focus:</label> <strong>' + target.cmana + '</strong>/' + target.mana + '</li>' +
				...
				'<ul class="col-md-2 score-stats list-unstyled">' +
					'<li class="stat-str first"><label>POWER:</label> ' + mods.str + ' <strong>(' + mods.str + ')</strong></li>' +
					'<li class="stat-wis"><label>PERCE:</label> ' + mods.wis + ' <strong>(' + mods.wis + ')</strong></li>' +
					'<li class="stat-int"><label>SMART:</label> ' + mods.int + ' <strong>(' + mods.int + ')</strong></li>' +
					'<li class="stat-dex"><label>SKILL:</label> ' + mods.dex + ' <strong>(' + mods.dex + ')</strong></li>' +
					'<li class="stat-con"><label>ENDUR:</label> ' + mods.con + ' <strong>(' + mods.con + ')</strong></li>' +
				'</ul>' +
				'<ul class="col-md-2 score-stats list-unstyled">' +
...
//					'<li class="stat-thirst"><label>Thirst:</label> ' + target.thirst +'</li>' +
					'<li class="stat-trains"><label>Trains:</label> ' + target.trains + '</li>' +
					'<li class="sin last"><label>SIN:</label> ' + target.sin + '</li>' +
				'</ul>' +
